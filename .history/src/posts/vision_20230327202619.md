...
```
## Licensing
We are adapting the Creative Commons Attribution ShareAlike 4.0 License by removing the requirement to indicate modifications and prohibiting changes to author tags. This will ensure the preservation of the lineage of ideas. Our aim is to create a license for cultural works, acknowledging that cultural changes often occur without clear attribution. The modified license will be called the Celtic Culture Attribution-ShareAlike 1.0 International Public License.
